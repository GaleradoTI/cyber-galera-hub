...
import { Plus, Pencil, Trash2, Eye, Users, BarChart3, Mail, Phone, X } from "lucide-react";
      ...
      <div className="glass rounded-xl border border-primary/20 overflow-x-auto">
        <Table>
          ...
          <TableBody>
            ...
            {!isLoading && events.length === 0 && <TableRow><TableCell colSpan={6} className="text-center py-8 text-muted-foreground">Nenhum evento.</TableCell></TableRow>}
            {events.map((ev) => (
              <TableRow key={ev.id}>
